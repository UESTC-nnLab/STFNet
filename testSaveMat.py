...
def test(opt, split, modelPath, show_flag, results_name, saveMat=False):
    ...
    # model = get_det_net({'hm': dataset.num_classes, 'wh': 2, 'reg': 2}, opt.model_name, opt)  
    ...
    for ind, (img_id, pre_processed_images) in enumerate(data_loader):
        ...
        if(show_flag):
            ...
            # cv2.waitKey(5)
            cv2.imwrite('figure/frame/%s.jpg'%(ind+1), frame)
...
if __name__ == '__main__':
    ...
    if opt.load_model != '':
        ...
        modelPath = 'weights/rsdata/DSFNet/weights2023_01_19_08_25_18/model_best.pth'
